...
public class DemoDataGenerator {
    ...
    static final Duration SHIFT_LENGTH = Duration.ofHours(5);
    static final Duration LUNCH_DURATION = Duration.ofHours(1);

    static final LocalTime MORNING_SHIFT_START_TIME = LocalTime.of(6, 0);
    static final LocalTime DAY_SHIFT_START_TIME = LocalTime.of(13, 0);
    static final LocalTime AFTERNOON_SHIFT_START_TIME = LocalTime.of(18, 0);
    static final LocalTime NIGHT_SHIFT_START_TIME = LocalTime.of(0, 0);
    static final LocalTime FIXED_LUNCH_START_TIME = LocalTime.of(12, 0);
    static final LocalTime FIXED_LUNCH_END_TIME = LocalTime.of(13, 0);
